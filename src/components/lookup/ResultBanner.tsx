    ...
    <section className="border-b border-border py-8 sm:py-10">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <FadeIn className="flex-1 min-w-0">
          ...
          {/* LiveAgeCounter sits OUTSIDE FadeIn — Framer must never wrap */}
          {/* the per-second ticker (CLAUDE.md hard rule).                  */}
        </FadeIn>
        <FadeIn delay={0.08} className="flex flex-row lg:flex-col items-center gap-4 lg:items-end">
